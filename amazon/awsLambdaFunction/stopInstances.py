...
instances = ec2.instances.filter(Filters = [{'Name':'tag:Name', 'Values':['testing*']}, {'Name':'instance-state-name', 'Values':['running']}])
...
def lambda_handler(event, context):
    if instancesContainer:
        ...
        print 'stopped your instances: ' + str(instancesContainer)
    else:
